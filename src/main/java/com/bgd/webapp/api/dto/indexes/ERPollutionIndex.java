...
public class ERPollutionIndex implements Serializable {
    private double value;
    private String chosenIndex;
    private ERPI_AIR_QUALITY airQualityStatus;
    ...
    public ERPollutionIndex(double PM10, double O3, double NO2, double CO, double SO2) {
    ...
    public ERPI_AIR_QUALITY getAirQualityStatus() {
        return airQualityStatus;
    }

    public void setAirQualityStatus(ERPI_AIR_QUALITY airQualityStatus) {
